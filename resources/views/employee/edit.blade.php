    ...
    <h4 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
      ...
      <input type="hidden" name="id"  value="{{$employee->id}}">
        <label class="block text-sm mb-5 ">
          ...
          <input type="rext" name="name" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray border-2 form-input" placeholder="Name" value="{{$employee->name ?? ''}}">
            @error('name')
        ...
        <label class="block text-sm mb-5">
          ...
          <input type="text" name="email"  autocomplete="email" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray border-2 form-input" placeholder="Email" value="{{$employee->email ?? ""}}">
           @error('email')
            <p class=" text-red-500 text-sm text-center  error">*{{ $message }} </p>
            @enderror
        </label>
        ...
        <label class="block text-sm mb-5">
          ...
          <input type="text" name="phone" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray border-2 form-input" placeholder="Phone" value="{{$employee->phone ?? ""}}">
           @error('phone')
            <p class=" text-red-500 text-sm text-center  error">*{{ $message }} </p>
            @enderror
        </label>
